      ...
      <section className="hero">
        <div className="hero-grid">
          <div>
            ...
            <h1>Serve Mother Cows.<br />Earn <em>Blessings.</em></h1>
            <p className="lead">
              Godham Trust runs shelter homes (goshalas) for rescued, injured, aged and abandoned
              cows — providing daily feed, medical care and a safe home for life. Every
              contribution goes directly to their care.
            </p>
            <div className="hero-ctas">
              <a href="#donate" className="btn btn-primary">Donate for Gau Seva →</a>
            ...
            <div className="hero-stats">
              ...
              <div><div className="num">3</div><div className="lbl">Goshalas run</div></div>
